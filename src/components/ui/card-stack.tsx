  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="pointer-events-none absolute inset-x-0 top-6 mx-auto h-48 w-[70%] rounded-full bg-black/5 blur-3xl dark:bg-primary/5"
          aria-hidden="true"
        />
        <div
  ...
  return (
    <div className="relative h-full w-full">
      ...
      <div className="relative z-10 flex h-full flex-col justify-end p-5">
        <div className="truncate text-lg font-semibold text-white drop-shadow-lg">
          {item.title}
        </div>
        {item.description ? (
          <div className="mt-1 line-clamp-2 text-sm text-white/80 drop-shadow-lg">
            {item.description}
          </div>
        ) : null}
      </div>
