      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                <label htmlFor="name" className="text-base font-medium text-foreground/80">Nome</label>
                            ...
                            <div className="space-y-2">
                                <label htmlFor="email" className="text-base font-medium text-foreground/80">E-mail</label>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                <label htmlFor="whatsapp" className="text-base font-medium text-foreground/80">WhatsApp (Opcional)</label>
                            ...
                            <div className="space-y-2">
                                <label htmlFor="company" className="text-base font-medium text-foreground/80">Empresa (Opcional)</label>
                        ...
                        <div className="space-y-2">
                            <label htmlFor="message" className="text-base font-medium text-foreground/80">Descreva seu projeto</label>
                        ...
                        <Button 
                            type="submit" 
                            size="lg" 
                            className="w-full bg-primary text-primary-foreground text-lg md:text-xl font-bold transition-all duration-300 hover:bg-primary/90 hover:scale-105 hover:drop-shadow-[0_0_10px_hsl(var(--primary))]"
        ...
        <div className="mt-12 text-center">
            <div className="relative flex justify-center items-center">
                ...
                <h3 className="relative bg-background px-4 text-2xl font-bold">Ou fale direto conosco!</h3>
            </div>
