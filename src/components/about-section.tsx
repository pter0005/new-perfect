...
export default function AboutSection() {
  ...
  return (
    <section id="about" className="relative py-20 sm:py-28 overflow-hidden bg-background">
      ...
      {/* Glow laranja no topo — z-0, atrás de tudo */}
      ...
      <div className="relative z-10 container mx-auto px-5 sm:px-8 lg:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-14 items-center mb-16 sm:mb-20">
          ...
          {/* ── Logo 3D — SEM container quadrado, só o canvas flutuando ── */}
          <motion.div
            ref={logoRef}
          ...
          >
            {/* Glow laranja difuso atrás — contido pelo isolate */}
            ...
            {/*
              Container do logo: sem border, sem background, sem overflow-hidden.
              O canvas 3D flutua livremente, 30% maior que antes (clamp anterior era ~240px–400px).
            */}
            <div
              className="relative w-full"
              style={{
                zIndex: 1,
                height: "clamp(310px, 49vw, 520px)", // +30% vs clamp(240px, 38vw, 400px)
              }}
            >
              <NewLogo3D />
              <p
          ...
          <div className="flex flex-col gap-5 order-1 lg:order-2">
            ...
            >
              NASCEMOS PARA<br />
              <span style={{ color: "hsl(var(--primary))", textShadow: "0 0 28px hsl(var(--primary)/0.38)" }}>
                TRANSFORMAR.
              </span>
            </motion.h2>
